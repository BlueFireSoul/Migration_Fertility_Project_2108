...
exportgraphics(ax1,'../object/g5_cn4_pop_diff.png')

ax2=g5b_fert_diff_graph(BasicCn.Cn4,Cn0,2);
exportgraphics(ax2,'../object/g5_cn4_frat_diff.png')

ax1=g5c_pop_comp_diff_graph(BasicCn.Cn4,Cn0,3);
exportgraphics(ax1,'../object/g5_cn4_comp_diff.png')

%% GE Maximize Support

ax1=g5a_pop_diff_graph(BasicCn.Cn3,Cn0,4);
exportgraphics(ax1,'../object/g5_cn3_pop_diff.png')

ax2=g5b_fert_diff_graph(BasicCn.Cn3,Cn0,5);
exportgraphics(ax2,'../object/g5_cn3_frat_diff.png')

ax1=g5c_pop_comp_diff_graph(BasicCn.Cn3,Cn0,6);
exportgraphics(ax1,'../object/g5_cn3_comp_diff.png')

%% Partial
load('../output/g4A_counterfactual_results.mat','BasicCn','Cn0');

ax1=g5a_pop_diff_graph(BasicCn.Cn4,Cn0,7);
exportgraphics(ax1,'../object/g5_cn4_pop_diff_partial.png')

ax2=g5b_fert_diff_graph(BasicCn.Cn4,Cn0,8);
exportgraphics(ax2,'../object/g5_cn4_frat_diff_partial.png')

ax1=g5c_pop_comp_diff_graph(BasicCn.Cn4,Cn0,9);
exportgraphics(ax1,'../object/g5_cn4_comp_diff_partial.png')

ax1=g5a_pop_diff_graph(BasicCn.Cn3,Cn0,10);
exportgraphics(ax1,'../object/g5_cn3_pop_diff_partial.png')

ax2=g5b_fert_diff_graph(BasicCn.Cn3,Cn0,11);
exportgraphics(ax2,'../object/g5_cn3_frat_diff_partial.png')

ax1=g5c_pop_comp_diff_graph(BasicCn.Cn3,Cn0,12);
exportgraphics(ax1,'../object/g5_cn3_comp_diff_partial.png')
%}

%% Function
function ax1=g5a_pop_diff_graph(Cn,Cn0,i)
    logr=log(Cn0.Solution.r);
    ...
    scatter(logr,PopDiffL,[],"red","o")
    lsline
    
    scatter(logr,PopDiffH,[],"blue","x")
    lsline
    h = lsline;
    set(h(1),'color','b')
    set(h(2),'color','red')
...
function ax2=g5b_fert_diff_graph(Cn,Cn0,i)
    ...
    hold on
    scatter(logr,FrateDiffL,[],"red","o")
    lsline
    scatter(logr,FrateDiffH,[],"blue","x")
    lsline
    h = lsline;
    set(h(1),'color','b')
    set(h(2),'color','red')
...
function ax1=g5c_pop_comp_diff_graph(Cn,Cn0,i)
    ...
    scatter(logr,CompDiffL,[],"red","o")
    lsline
    
    scatter(logr,CompDiffH,[],"blue","x")
    lsline
    h = lsline;
    set(h(1),'color','b')
    set(h(2),'color','red')
